...
/* loaded from: libverify-2.11.0.aar:classes.jar:ru/mail/verify/core/utils/MD5.class */
public abstract class MD5 {
    public static String digestHex(String data) throws UnsupportedEncodingException {
        byte[] bytes = data.getBytes("UTF-8");
        return Utils.bytesToHexString(digest(bytes, bytes.length));
    }

    public static byte[] digest(byte[] data, int len) {
        int[] iArr = new int[16];
        int[] iArr2 = {1732584193, -271733879, -1732584194, 271733878};
        int[] iArr3 = new int[2];
        byte[] bArr = new byte[64];
        a(data, len, iArr, iArr2, iArr3, bArr);
    ...
    public static String digestHex(byte[] data) {
        return Utils.bytesToHexString(digest(data, data.length));
    }
    ...
    private static void a(byte[] bArr, int[] iArr, int[] iArr2) {
        ...
        do {
            ...
            int i8 = i7 + 1;
            i4 = i8;
            iArr[i3] = (bArr[i5] & 255) | ((bArr[i6] & 255) << 8) | ((bArr[i7] & 255) << 16) | (bArr[i8] << 24);
            i = i3 + 1;
            i3 = i;
        } while (i < 16);
        int i9 = iArr2[1];
        int i10 = iArr2[2];
        int a = a(i9, i10, iArr2[3], 7, (iArr2[0] + iArr[0]) - 680876936);
        int a2 = a(a, i9, i10, 12, (i2 + iArr[1]) - 389564586);
        int a3 = a(a2, a, i9, 17, i10 + iArr[2] + 606105819);
        int a4 = a(a3, a2, a, 22, (i9 + iArr[3]) - 1044525330);
    ...
    public static String digestHex(byte[] data, int len) {
        return Utils.bytesToHexString(digest(data, len));
    }

    private static void a(byte[] bArr, int i, int[] iArr, int[] iArr2, int[] iArr3, byte[] bArr2) {
        ...
        System.arraycopy(bArr, i7, bArr2, i3, i - i7);
    }
}
